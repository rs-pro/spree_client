...
# Unit tests for SpreeClient::CreateAddressParamsAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SpreeClient::CreateAddressParamsAddress do
  let(:instance) { SpreeClient::CreateAddressParamsAddress.new }

  describe 'test an instance of CreateAddressParamsAddress' do
    it 'should create an instance of CreateAddressParamsAddress' do
      expect(instance).to be_instance_of(SpreeClient::CreateAddressParamsAddress)
    end
  end
