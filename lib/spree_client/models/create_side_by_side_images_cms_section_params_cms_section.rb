...
module SpreeClient
  class CreateSideBySideImagesCmsSectionParamsCmsSection
    ...
    # Set the subtitle used in image one.
    attr_accessor :subtitle_one

    # Set the subtitle used in image two.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SpreeClient::CreateSideBySideImagesCmsSectionParamsCmsSection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SpreeClient::CreateSideBySideImagesCmsSectionParamsCmsSection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["Spree::Cms::Sections::SideBySideImages"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Spree::Cms::Sections::SideBySideImages"])
    ...
    def hash
      [name, cms_page_id, type, position, link_type_one, link_type_two, link_one, link_two, title_one, title_two, fit, subtitle_one, subtitle_two, gutters, cms_section_image_one, cms_section_image_two].hash
    end
