...
module SpreeClient
  class UpdateImageGalleryCmsSectionParamsCmsSection
    ...
    # Update the resource type that image three links to.
    ...
    # Update the slug or path that image three links to.
    ...
    # Update the title used in image three.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SpreeClient::UpdateImageGalleryCmsSectionParamsCmsSection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SpreeClient::UpdateImageGalleryCmsSectionParamsCmsSection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [name, type, position, link_type_one, link_type_two, link_type_three, link_one, link_two, link_three, title_one, title_two, title_three, fit, layout_style, display_labels, cms_section_image_one, cms_section_image_two, cms_section_image_three].hash
    end
