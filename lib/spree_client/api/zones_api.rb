...
module SpreeClient
  class ZonesApi
    ...
    def create_zone_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = '/api/v2/platform/zones'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'create_zone_params'])
    ...
    def delete_zone(id, opts = {})
      delete_zone_with_http_info(id, opts)
      nil
    end
    ...
    def delete_zone_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/api/v2/platform/zones/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    # @option opts [String] :include Select which associated resources you would like to fetch, see: &lt;a href&#x3D;\&quot;https://jsonapi.org/format/#fetching-includes\&quot;&gt;https://jsonapi.org/format/#fetching-includes&lt;/a&gt;
    # @return [Resource]
    def show_zone(id, opts = {})
      data, _status_code, _headers = show_zone_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :include Select which associated resources you would like to fetch, see: &lt;a href&#x3D;\&quot;https://jsonapi.org/format/#fetching-includes\&quot;&gt;https://jsonapi.org/format/#fetching-includes&lt;/a&gt;
    # @return [Array<(Resource, Integer, Hash)>] Resource data, response status code and response headers
    def show_zone_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ZonesApi.show_zone ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ZonesApi.show_zone"
      end
      # resource path
      local_var_path = '/api/v2/platform/zones/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ZonesApi#show_zone\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_zone_with_http_info(id, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'update_zone_params'])
    ...
    def zones_list(opts = {})
      data, _status_code, _headers = zones_list_with_http_info(opts)
      data
    end
    ...
    def zones_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ZonesApi.zones_list ...'
      end
      # resource path
      local_var_path = '/api/v2/platform/zones'
      ...
      query_params[:'include'] = opts[:'include'] if !opts[:'include'].nil?
      query_params[:'filter[description_eq]'] = opts[:'filter_description_eq'] if !opts[:'filter_description_eq'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ZonesApi#zones_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
